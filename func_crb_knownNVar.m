...
function tempFIM = func_crb_knownNVar(thresR, thresI, thetaVec, phiVec, Gamma, hVec, S, A_ms, A_bs, N_tx, N_rx, M, nvar)
% function to compute FIM for angular-domain channel estimation
% (AoA, AoD, and channel path gain) with 1-bit ADC when the noise variance is known
%
